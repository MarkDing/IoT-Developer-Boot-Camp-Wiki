...
- [Switching Between Two Zigbee Applications Using Slot Manager](#switching-between-two-zigbee-applications-using-slot-manager)
  - [1. Summary](#1-summary)
  ...
  - [5. Setup](#5-setup)
    - [5.1 Bootloader application](#51-bootloader-application)
    - [5.2 ZigBee applications](#52-zigbee-applications)
      - [5.2.1 Z3LIGHT_ZC](#521-z3light_zc)
      - [5.2.2 Z3SWITCH_SED](#522-z3switch_sed)
  - [6. How It Works](#6-how-it-works)
    - [6.1 Upload applications into the device](#61-upload-applications-into-the-device)
    - [6.2 Switch between two applications](#62-switch-between-two-applications)
