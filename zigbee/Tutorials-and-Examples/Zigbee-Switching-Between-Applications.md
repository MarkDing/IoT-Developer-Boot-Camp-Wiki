...
- [Switching Between Two Zigbee Applications](#switching-between-two-zigbee-applications)
  - [1. Summary](#1-summary)
  ...
  - [5. Setup](#5-setup)
    - [5.1. Create Application for Area 0](#51-create-application-for-area-0)
    - [5.2. Create Application for Area 1](#52-create-application-for-area-1)
    - [5.3. Add a Custom Command to Switch](#53-add-a-custom-command-to-switch)
    - [5.4. Modify the Bootloader to Bootload Application According to Reset Cause](#54-modify-the-bootloader-to-bootload-application-according-to-reset-cause)
