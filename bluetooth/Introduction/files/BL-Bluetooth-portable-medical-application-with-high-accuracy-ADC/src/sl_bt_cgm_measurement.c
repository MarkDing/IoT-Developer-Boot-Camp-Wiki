...
/* flags: 110 0011 */
static uint8_t sl_glucose_concentration[] = {0x0F,0xE3,04,00,00,00,01,01,\
 ...
 *****************************************************************************/
void CGM_measurement_periodic_timeout(sl_simple_timer_t *handle, void *data)
{
  (void)&handle;
  (void)&data;
  uint8_t ret = adcPollResult();
  /* get adc data as Concentration data  */
  sl_glucose_concentration[2] = (ret > 10)?(ret - 10):ret ;
  app_log("periodic measurement Glucose Concentration %d mmol/L\n",
